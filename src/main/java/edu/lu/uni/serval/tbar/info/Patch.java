...
public class Patch {
	...
	// sso : add
	public int scn_index = -1;
	public String fixedContextStr = "";

	public void setFixedContextStr(String fixedContextStr){
		this.fixedContextStr = fixedContextStr;
	}

	public String getFixedContextStr(){
		return fixedContextStr;
	}

	public void setScnIndex(int scn_index){
		this.scn_index = scn_index;
	}
